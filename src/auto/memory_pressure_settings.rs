...
impl MemoryPressureSettings {
    ...
    pub fn new() -> MemoryPressureSettings {
        ...
        unsafe {
            from_glib_full(ffi::webkit_memory_pressure_settings_new())
        }
    }
    ...
    pub fn memory_limit(&mut self) -> u32 {
        unsafe {
            ffi::webkit_memory_pressure_settings_get_memory_limit(self.to_glib_none_mut().0)
        }
    }
    ...
    pub fn poll_interval(&mut self) -> f64 {
        unsafe {
            ffi::webkit_memory_pressure_settings_get_poll_interval(self.to_glib_none_mut().0)
        }
    }
    ...
    pub fn set_conservative_threshold(&mut self, value: f64) {
        unsafe {
            ffi::webkit_memory_pressure_settings_set_conservative_threshold(self.to_glib_none_mut().0, value);
        }
    }
    ...
    pub fn set_memory_limit(&mut self, memory_limit: u32) {
        unsafe {
            ffi::webkit_memory_pressure_settings_set_memory_limit(self.to_glib_none_mut().0, memory_limit);
        }
    }
