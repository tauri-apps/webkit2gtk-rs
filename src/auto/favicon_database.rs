...
pub trait FaviconDatabaseExt {
    ...
    //fn get_favicon<'a, 'b, P: Into<Option<&'a /*Ignored*/gio::Cancellable>>, Q: Into<Option<&'b /*Ignored*/gio::AsyncReadyCallback>>, R: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(&self, page_uri: &str, cancellable: P, callback: Q, user_data: R);

    //fn get_favicon_finish<P: IsA</*Ignored*/gio::AsyncResult>>(&self, result: &P) -> Result</*Ignored*/cairo::Surface, Error>;

    fn get_favicon_uri(&self, page_uri: &str) -> Option<String>;

    fn connect_favicon_changed<F: Fn(&Self, &str, &str) + 'static>(&self, f: F) -> u64;
}
...
where P: IsA<FaviconDatabase> {
    ...
    f(&FaviconDatabase::from_glib_none(this).downcast_unchecked(), &String::from_glib_none(page_uri), &String::from_glib_none(favicon_uri))
}
