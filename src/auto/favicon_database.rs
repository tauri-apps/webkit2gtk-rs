...
pub trait FaviconDatabaseExt: 'static {
    ...
    fn favicon<P: FnOnce(Result<cairo::Surface, glib::Error>) + Send + 'static>(&self, page_uri: &str, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P);
...
impl<O: IsA<FaviconDatabase>> FaviconDatabaseExt for O {
    ...
    fn favicon<P: FnOnce(Result<cairo::Surface, glib::Error>) + Send + 'static>(&self, page_uri: &str, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P) {
        ...
        unsafe extern "C" fn favicon_trampoline<P: FnOnce(Result<cairo::Surface, glib::Error>) + Send + 'static>(_source_object: *mut glib::gobject_ffi::GObject, res: *mut gio::ffi::GAsyncResult, user_data: glib::ffi::gpointer) {
