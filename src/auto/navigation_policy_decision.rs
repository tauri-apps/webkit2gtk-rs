...
pub trait NavigationPolicyDecisionExt {
    ...
    fn connect_property_frame_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_modifiers_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_mouse_button_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v2_6")]
    fn connect_property_navigation_action_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_navigation_type_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
