...
bitflags! {
    pub struct WebsiteDataTypes: u32 {
        const WEBSITE_DATA_MEMORY_CACHE = 1;
        const WEBSITE_DATA_DISK_CACHE = 2;
        const WEBSITE_DATA_OFFLINE_APPLICATION_CACHE = 4;
        const WEBSITE_DATA_SESSION_STORAGE = 8;
        const WEBSITE_DATA_LOCAL_STORAGE = 16;
        const WEBSITE_DATA_WEBSQL_DATABASES = 32;
        const WEBSITE_DATA_INDEXEDDB_DATABASES = 64;
        const WEBSITE_DATA_PLUGIN_DATA = 128;
        const WEBSITE_DATA_COOKIES = 256;
        const WEBSITE_DATA_ALL = 511;
    }
}
