...
pub trait SettingsExt {
    ...
    #[cfg(feature = "v2_10")]
    fn connect_property_allow_file_access_from_file_urls_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_allow_modal_dialogs_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v2_14")]
    fn connect_property_allow_universal_access_from_file_urls_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_auto_load_images_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_cursive_font_family_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_default_charset_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_default_font_family_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_default_font_size_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_default_monospace_font_size_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_draw_compositing_indicators_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v2_2")]
    fn connect_property_enable_accelerated_2d_canvas_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_enable_caret_browsing_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_enable_developer_extras_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_enable_dns_prefetching_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_enable_frame_flattening_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_enable_fullscreen_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_enable_html5_database_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_enable_html5_local_storage_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_enable_hyperlink_auditing_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_enable_java_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_enable_javascript_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v2_4")]
    fn connect_property_enable_media_stream_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v2_4")]
    fn connect_property_enable_mediasource_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_enable_offline_web_application_cache_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_enable_page_cache_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_enable_plugins_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_enable_private_browsing_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_enable_resizable_text_areas_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_enable_site_specific_quirks_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_enable_smooth_scrolling_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v2_4")]
    fn connect_property_enable_spatial_navigation_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_enable_tabs_to_links_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_enable_webaudio_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_enable_webgl_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v2_2")]
    fn connect_property_enable_write_console_messages_to_stdout_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_enable_xss_auditor_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_fantasy_font_family_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v2_16")]
    fn connect_property_hardware_acceleration_policy_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_javascript_can_access_clipboard_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_javascript_can_open_windows_automatically_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_load_icons_ignoring_image_load_setting_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_media_playback_allows_inline_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_media_playback_requires_user_gesture_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_minimum_font_size_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_monospace_font_family_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_pictograph_font_family_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_print_backgrounds_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_sans_serif_font_family_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_serif_font_family_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_user_agent_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_zoom_text_only_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}
