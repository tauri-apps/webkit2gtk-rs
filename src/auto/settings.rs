...
pub trait SettingsExt: 'static {
  ...
  fn connect_enable_developer_extras_notify<F: Fn(&Self) + 'static>(&self, f: F)
    -> SignalHandlerId;
  ...
  fn connect_enable_private_browsing_notify<F: Fn(&Self) + 'static>(&self, f: F)
    -> SignalHandlerId;
  ...
  fn connect_enable_smooth_scrolling_notify<F: Fn(&Self) + 'static>(&self, f: F)
    -> SignalHandlerId;
