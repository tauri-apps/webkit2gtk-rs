...
impl<O: IsA<ResponsePolicyDecision>> ResponsePolicyDecisionExt for O {
    ...
    fn connect_property_request_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_request_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitResponsePolicyDecision, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
    ...
    fn connect_property_response_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_response_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitResponsePolicyDecision, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<ResponsePolicyDecision>
        {
            let f: &F = &*(f as *const F);
            f(&ResponsePolicyDecision::from_glib_borrow(this).unsafe_cast_ref())
