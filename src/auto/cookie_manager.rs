...
impl CookieManager {
    ...
    //pub fn get_accept_policy_finish<T: IsA</*Ignored*/gio::AsyncResult>>(&self, result: &T) -> Result<CookieAcceptPolicy, Error> {
    ...
    //pub fn get_domains_with_cookies_finish<T: IsA</*Ignored*/gio::AsyncResult>>(&self, result: &T) -> Result<Vec<String>, Error> {
