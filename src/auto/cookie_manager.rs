...
pub trait CookieManagerExt: 'static {
    ...
    fn add_cookie<P: FnOnce(Result<(), glib::Error>) + 'static>(&self, cookie: &mut soup::Cookie, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P);

    
    #[cfg(any(feature = "v2_20", feature = "dox"))]
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_20")))]
    fn add_cookie_future(&self, cookie: &mut soup::Cookie) -> Pin<Box_<dyn std::future::Future<Output = Result<(), glib::Error>> + 'static>>;
    ...
    fn delete_cookie<P: FnOnce(Result<(), glib::Error>) + 'static>(&self, cookie: &mut soup::Cookie, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P);

    
    #[cfg(any(feature = "v2_20", feature = "dox"))]
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_20")))]
    fn delete_cookie_future(&self, cookie: &mut soup::Cookie) -> Pin<Box_<dyn std::future::Future<Output = Result<(), glib::Error>> + 'static>>;
    ...
    fn cookies<P: FnOnce(Result<Vec<soup::Cookie>, glib::Error>) + 'static>(&self, uri: &str, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P);

    
    #[cfg(any(feature = "v2_20", feature = "dox"))]
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_20")))]
    fn cookies_future(&self, uri: &str) -> Pin<Box_<dyn std::future::Future<Output = Result<Vec<soup::Cookie>, glib::Error>> + 'static>>;

    #[cfg_attr(feature = "v2_16", deprecated = "Since 2.16")]
    #[doc(alias = "webkit_cookie_manager_get_domains_with_cookies")]
    #[doc(alias = "get_domains_with_cookies")]
    fn domains_with_cookies<P: FnOnce(Result<Vec<glib::GString>, glib::Error>) + 'static>(&self, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P);
...
impl<O: IsA<CookieManager>> CookieManagerExt for O {
    ...
    fn add_cookie<P: FnOnce(Result<(), glib::Error>) + 'static>(&self, cookie: &mut soup::Cookie, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P) {
        ...
        unsafe extern "C" fn add_cookie_trampoline<P: FnOnce(Result<(), glib::Error>) + 'static>(_source_object: *mut glib::gobject_ffi::GObject, res: *mut gio::ffi::GAsyncResult, user_data: glib::ffi::gpointer) {
            let mut error = ptr::null_mut();
            let _ = ffi::webkit_cookie_manager_add_cookie_finish(_source_object as *mut _, res, &mut error);
        ...
        unsafe {
            ffi::webkit_cookie_manager_add_cookie(self.as_ref().to_glib_none().0, cookie.to_glib_none_mut().0, cancellable.map(|p| p.as_ref()).to_glib_none().0, Some(callback), Box_::into_raw(user_data) as *mut _);
        }
    }
    ...
    fn delete_cookie<P: FnOnce(Result<(), glib::Error>) + 'static>(&self, cookie: &mut soup::Cookie, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P) {
        ...
        let user_data: Box_<glib::thread_guard::ThreadGuard<P>> = Box_::new(glib::thread_guard::ThreadGuard::new(callback));
        unsafe extern "C" fn delete_cookie_trampoline<P: FnOnce(Result<(), glib::Error>) + 'static>(_source_object: *mut glib::gobject_ffi::GObject, res: *mut gio::ffi::GAsyncResult, user_data: glib::ffi::gpointer) {
            let mut error = ptr::null_mut();
            let _ = ffi::webkit_cookie_manager_delete_cookie_finish(_source_object as *mut _, res, &mut error);
            let result = if error.is_null() { Ok(()) } else { Err(from_glib_full(error)) };
            let callback: Box_<glib::thread_guard::ThreadGuard<P>> = Box_::from_raw(user_data as *mut _);
            let callback: P = callback.into_inner();
            callback(result);
        ...
        unsafe {
            ffi::webkit_cookie_manager_delete_cookie(self.as_ref().to_glib_none().0, cookie.to_glib_none_mut().0, cancellable.map(|p| p.as_ref()).to_glib_none().0, Some(callback), Box_::into_raw(user_data) as *mut _);
        }
    }
    ...
    fn cookies<P: FnOnce(Result<Vec<soup::Cookie>, glib::Error>) + 'static>(&self, uri: &str, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P) {
        ...
        let user_data: Box_<glib::thread_guard::ThreadGuard<P>> = Box_::new(glib::thread_guard::ThreadGuard::new(callback));
        unsafe extern "C" fn cookies_trampoline<P: FnOnce(Result<Vec<soup::Cookie>, glib::Error>) + 'static>(_source_object: *mut glib::gobject_ffi::GObject, res: *mut gio::ffi::GAsyncResult, user_data: glib::ffi::gpointer) {
            let mut error = ptr::null_mut();
            let ret = ffi::webkit_cookie_manager_get_cookies_finish(_source_object as *mut _, res, &mut error);
        ...
        unsafe {
            ffi::webkit_cookie_manager_get_cookies(self.as_ref().to_glib_none().0, uri.to_glib_none().0, cancellable.map(|p| p.as_ref()).to_glib_none().0, Some(callback), Box_::into_raw(user_data) as *mut _);
        }
    }
    ...
    fn domains_with_cookies<P: FnOnce(Result<Vec<glib::GString>, glib::Error>) + 'static>(&self, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P) {
        ...
        let user_data: Box_<glib::thread_guard::ThreadGuard<P>> = Box_::new(glib::thread_guard::ThreadGuard::new(callback));
        unsafe extern "C" fn domains_with_cookies_trampoline<P: FnOnce(Result<Vec<glib::GString>, glib::Error>) + 'static>(_source_object: *mut glib::gobject_ffi::GObject, res: *mut gio::ffi::GAsyncResult, user_data: glib::ffi::gpointer) {
            let mut error = ptr::null_mut();
