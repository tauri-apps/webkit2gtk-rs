...
pub trait CookieManagerExt: 'static {
    ...
    //fn add_cookie<P: FnOnce(Result<(), glib::Error>) + Send + 'static>(&self, cookie: /*Ignored*/&mut soup::Cookie, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P);
    ...
    //fn delete_cookie<P: FnOnce(Result<(), glib::Error>) + Send + 'static>(&self, cookie: /*Ignored*/&mut soup::Cookie, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P);
    ...
    fn accept_policy<P: FnOnce(Result<CookieAcceptPolicy, glib::Error>) + Send + 'static>(&self, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P);
    ...
    //fn cookies<P: FnOnce(Result</*Ignored*/Vec<soup::Cookie>, glib::Error>) + Send + 'static>(&self, uri: &str, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P);
    ...
    fn domains_with_cookies<P: FnOnce(Result<Vec<glib::GString>, glib::Error>) + Send + 'static>(&self, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P);
...
impl<O: IsA<CookieManager>> CookieManagerExt for O {
    ...
    fn accept_policy<P: FnOnce(Result<CookieAcceptPolicy, glib::Error>) + Send + 'static>(&self, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P) {
        ...
        unsafe extern "C" fn accept_policy_trampoline<P: FnOnce(Result<CookieAcceptPolicy, glib::Error>) + Send + 'static>(_source_object: *mut glib::gobject_ffi::GObject, res: *mut gio::ffi::GAsyncResult, user_data: glib::ffi::gpointer) {
    ...
    fn domains_with_cookies<P: FnOnce(Result<Vec<glib::GString>, glib::Error>) + Send + 'static>(&self, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P) {
        let user_data: Box_<P> = Box_::new(callback);
        unsafe extern "C" fn domains_with_cookies_trampoline<P: FnOnce(Result<Vec<glib::GString>, glib::Error>) + Send + 'static>(_source_object: *mut glib::gobject_ffi::GObject, res: *mut gio::ffi::GAsyncResult, user_data: glib::ffi::gpointer) {
            let mut error = ptr::null_mut();
