...
impl<O: IsA<URIResponse>> URIResponseExt for O {
    ...
    fn connect_property_content_length_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_content_length_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitURIResponse, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_6")))]
    fn connect_property_http_headers_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_http_headers_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitURIResponse, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<URIResponse>
        {
            let f: &F = &*(f as *const F);
            f(&URIResponse::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_mime_type_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_mime_type_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitURIResponse, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<URIResponse>
        {
            let f: &F = &*(f as *const F);
            f(&URIResponse::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_status_code_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_status_code_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitURIResponse, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<URIResponse>
        {
            let f: &F = &*(f as *const F);
            f(&URIResponse::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_suggested_filename_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_suggested_filename_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitURIResponse, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<URIResponse>
        {
            let f: &F = &*(f as *const F);
            f(&URIResponse::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_uri_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_uri_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitURIResponse, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<URIResponse>
        {
            let f: &F = &*(f as *const F);
            f(&URIResponse::from_glib_borrow(this).unsafe_cast_ref())
