...
impl URIRequest {
    ...
    /// Creates a new builder-style object to construct a [`URIRequest`].
    ///
    /// This method returns an instance of [`URIRequestBuilder`] which can be used to create a [`URIRequest`].
...
// rustdoc-stripper-ignore-next
/// A builder for generating a [`URIRequest`].
