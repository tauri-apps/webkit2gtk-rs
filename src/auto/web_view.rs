...
pub struct WebViewBuilder {
    ...
    //events: /*Unknown type*/,
    #[cfg(any(feature = "v3", feature = "dox"))]
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v3")))]
    expand: Option<bool>,
...
pub trait WebViewExt: 'static {
    ...
    fn can_execute_editing_command<P: FnOnce(Result<(), glib::Error>) + Send + 'static>(&self, command: &str, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P);
    ...
    fn snapshot<P: FnOnce(Result<cairo::Surface, glib::Error>) + Send + 'static>(&self, region: SnapshotRegion, options: SnapshotOptions, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P);
    ...
    fn run_javascript<P: FnOnce(Result<JavascriptResult, glib::Error>) + Send + 'static>(&self, script: &str, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P);
    ...
    fn run_javascript_from_gresource<P: FnOnce(Result<JavascriptResult, glib::Error>) + Send + 'static>(&self, resource: &str, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P);
    ...
    fn run_javascript_in_world<P: FnOnce(Result<JavascriptResult, glib::Error>) + Send + 'static>(&self, script: &str, world_name: &str, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P);
    ...
    fn save<P: FnOnce(Result<gio::InputStream, glib::Error>) + Send + 'static>(&self, save_mode: SaveMode, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P);
    ...
    fn save_to_file<P: FnOnce(Result<(), glib::Error>) + Send + 'static>(&self, file: &impl IsA<gio::File>, save_mode: SaveMode, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P);
    ...
    fn send_message_to_page<P: FnOnce(Result<UserMessage, glib::Error>) + Send + 'static>(&self, message: &impl IsA<UserMessage>, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P);
...
impl<O: IsA<WebView>> WebViewExt for O {
    fn can_execute_editing_command<P: FnOnce(Result<(), glib::Error>) + Send + 'static>(&self, command: &str, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P) {
        ...
        unsafe extern "C" fn can_execute_editing_command_trampoline<P: FnOnce(Result<(), glib::Error>) + Send + 'static>(_source_object: *mut glib::gobject_ffi::GObject, res: *mut gio::ffi::GAsyncResult, user_data: glib::ffi::gpointer) {
    ...
    fn snapshot<P: FnOnce(Result<cairo::Surface, glib::Error>) + Send + 'static>(&self, region: SnapshotRegion, options: SnapshotOptions, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P) {
        let user_data: Box_<P> = Box_::new(callback);
        unsafe extern "C" fn snapshot_trampoline<P: FnOnce(Result<cairo::Surface, glib::Error>) + Send + 'static>(_source_object: *mut glib::gobject_ffi::GObject, res: *mut gio::ffi::GAsyncResult, user_data: glib::ffi::gpointer) {
            let mut error = ptr::null_mut();
    ...
    fn run_javascript<P: FnOnce(Result<JavascriptResult, glib::Error>) + Send + 'static>(&self, script: &str, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P) {
        let user_data: Box_<P> = Box_::new(callback);
        unsafe extern "C" fn run_javascript_trampoline<P: FnOnce(Result<JavascriptResult, glib::Error>) + Send + 'static>(_source_object: *mut glib::gobject_ffi::GObject, res: *mut gio::ffi::GAsyncResult, user_data: glib::ffi::gpointer) {
            let mut error = ptr::null_mut();
    ...
    fn run_javascript_from_gresource<P: FnOnce(Result<JavascriptResult, glib::Error>) + Send + 'static>(&self, resource: &str, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P) {
        let user_data: Box_<P> = Box_::new(callback);
        unsafe extern "C" fn run_javascript_from_gresource_trampoline<P: FnOnce(Result<JavascriptResult, glib::Error>) + Send + 'static>(_source_object: *mut glib::gobject_ffi::GObject, res: *mut gio::ffi::GAsyncResult, user_data: glib::ffi::gpointer) {
            let mut error = ptr::null_mut();
    ...
    fn run_javascript_in_world<P: FnOnce(Result<JavascriptResult, glib::Error>) + Send + 'static>(&self, script: &str, world_name: &str, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P) {
        let user_data: Box_<P> = Box_::new(callback);
        unsafe extern "C" fn run_javascript_in_world_trampoline<P: FnOnce(Result<JavascriptResult, glib::Error>) + Send + 'static>(_source_object: *mut glib::gobject_ffi::GObject, res: *mut gio::ffi::GAsyncResult, user_data: glib::ffi::gpointer) {
            let mut error = ptr::null_mut();
    ...
    fn save<P: FnOnce(Result<gio::InputStream, glib::Error>) + Send + 'static>(&self, save_mode: SaveMode, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P) {
        let user_data: Box_<P> = Box_::new(callback);
        unsafe extern "C" fn save_trampoline<P: FnOnce(Result<gio::InputStream, glib::Error>) + Send + 'static>(_source_object: *mut glib::gobject_ffi::GObject, res: *mut gio::ffi::GAsyncResult, user_data: glib::ffi::gpointer) {
            let mut error = ptr::null_mut();
    ...
    fn save_to_file<P: FnOnce(Result<(), glib::Error>) + Send + 'static>(&self, file: &impl IsA<gio::File>, save_mode: SaveMode, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P) {
        let user_data: Box_<P> = Box_::new(callback);
        unsafe extern "C" fn save_to_file_trampoline<P: FnOnce(Result<(), glib::Error>) + Send + 'static>(_source_object: *mut glib::gobject_ffi::GObject, res: *mut gio::ffi::GAsyncResult, user_data: glib::ffi::gpointer) {
            let mut error = ptr::null_mut();
    ...
    fn send_message_to_page<P: FnOnce(Result<UserMessage, glib::Error>) + Send + 'static>(&self, message: &impl IsA<UserMessage>, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P) {
        let user_data: Box_<P> = Box_::new(callback);
        unsafe extern "C" fn send_message_to_page_trampoline<P: FnOnce(Result<UserMessage, glib::Error>) + Send + 'static>(_source_object: *mut glib::gobject_ffi::GObject, res: *mut gio::ffi::GAsyncResult, user_data: glib::ffi::gpointer) {
            let mut error = ptr::null_mut();
