...
pub trait WebViewExt {
    ...
    //fn get_snapshot_finish<P: IsA</*Ignored*/gio::AsyncResult>>(&self, result: &P) -> Result<cairo::Surface, Error>;
    ...
    fn connect_context_menu<F: Fn(&Self, &ContextMenu, &gdk::Event, &HitTestResult) -> bool + 'static>(&self, f: F) -> u64;
    ...
    #[cfg(feature = "v2_6")]
    fn connect_load_failed_with_tls_errors<F: Fn(&Self, &str, &gio::TlsCertificate, gio::TlsCertificateFlags) -> bool + 'static>(&self, f: F) -> u64;
    ...
    fn connect_property_estimated_load_progress_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_favicon_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v2_16")]
    fn connect_property_is_ephemeral_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_is_loading_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v2_8")]
    fn connect_property_is_playing_audio_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v2_4")]
    fn connect_property_related_view_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
    ...
    #[cfg(feature = "v2_6")]
    fn connect_property_user_content_manager_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_web_context_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_zoom_level_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}
