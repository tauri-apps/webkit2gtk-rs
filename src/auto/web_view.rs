...
if let Some(ref width_request) = self.width_request {
        ...
        let ret = glib::Object::new::<WebView>(&properties)
            .expect("object new");
    ret
    }
...
pub trait WebViewExt: 'static {
    ...
    #[doc(alias = "get_property_web_context")]
...
impl<O: IsA<WebView>> WebViewExt for O {
    ...
    fn get_snapshot<P: IsA<gio::Cancellable>, Q: FnOnce(Result<cairo::Surface, glib::Error>) + Send + 'static>(&self, region: SnapshotRegion, options: SnapshotOptions, cancellable: Option<&P>, callback: Q) {
        let user_data: Box_<Q> = Box_::new(callback);
        unsafe extern "C" fn get_snapshot_trampoline<Q: FnOnce(Result<cairo::Surface, glib::Error>) + Send + 'static>(_source_object: *mut glib::gobject_ffi::GObject, res: *mut gio::ffi::GAsyncResult, user_data: glib::ffi::gpointer) {
            let mut error = ptr::null_mut();
        ...
        unsafe {
            ffi::webkit_web_view_get_snapshot(self.as_ref().to_glib_none().0, region.to_glib(), options.to_glib(), cancellable.map(|p| p.as_ref()).to_glib_none().0, Some(callback), Box_::into_raw(user_data) as *mut _);
        }
    }
    ...
    fn save<P: IsA<gio::Cancellable>, Q: FnOnce(Result<gio::InputStream, glib::Error>) + Send + 'static>(&self, save_mode: SaveMode, cancellable: Option<&P>, callback: Q) {
        ...
        unsafe {
            ffi::webkit_web_view_save(self.as_ref().to_glib_none().0, save_mode.to_glib(), cancellable.map(|p| p.as_ref()).to_glib_none().0, Some(callback), Box_::into_raw(user_data) as *mut _);
        }
    }
    ...
    fn save_to_file<P: IsA<gio::File>, Q: IsA<gio::Cancellable>, R: FnOnce(Result<(), glib::Error>) + Send + 'static>(&self, file: &P, save_mode: SaveMode, cancellable: Option<&Q>, callback: R) {
        ...
        unsafe {
            ffi::webkit_web_view_save_to_file(self.as_ref().to_glib_none().0, file.as_ref().to_glib_none().0, save_mode.to_glib(), cancellable.map(|p| p.as_ref()).to_glib_none().0, Some(callback), Box_::into_raw(user_data) as *mut _);
        }
    }
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_2")))]
    fn connect_authenticate<F: Fn(&Self, &AuthenticationRequest) -> bool + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn authenticate_trampoline<P, F: Fn(&P, &AuthenticationRequest) -> bool + 'static>(this: *mut ffi::WebKitWebView, request: *mut ffi::WebKitAuthenticationRequest, f: glib::ffi::gpointer) -> glib::ffi::gboolean
            where P: IsA<WebView>
        {
    ...
    fn connect_close<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn close_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitWebView, f: glib::ffi::gpointer)
            where P: IsA<WebView>
        {
            let f: &F = &*(f as *const F);
    ...
    fn connect_context_menu<F: Fn(&Self, &ContextMenu, &gdk::Event, &HitTestResult) -> bool + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn context_menu_trampoline<P, F: Fn(&P, &ContextMenu, &gdk::Event, &HitTestResult) -> bool + 'static>(this: *mut ffi::WebKitWebView, context_menu: *mut ffi::WebKitContextMenu, event: *mut gdk::ffi::GdkEvent, hit_test_result: *mut ffi::WebKitHitTestResult, f: glib::ffi::gpointer) -> glib::ffi::gboolean
            where P: IsA<WebView>
        {
            let f: &F = &*(f as *const F);
    ...
    fn connect_context_menu_dismissed<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn context_menu_dismissed_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitWebView, f: glib::ffi::gpointer)
            where P: IsA<WebView>
        {
            let f: &F = &*(f as *const F);
            f(&WebView::from_glib_borrow(this).unsafe_cast_ref())
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_6")))]
    fn connect_create<F: Fn(&Self, &NavigationAction) -> Option<gtk::Widget> + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn create_trampoline<P, F: Fn(&P, &NavigationAction) -> Option<gtk::Widget> + 'static>(this: *mut ffi::WebKitWebView, navigation_action: *mut ffi::WebKitNavigationAction, f: glib::ffi::gpointer) -> *mut gtk::ffi::GtkWidget
            where P: IsA<WebView>
        {
            let f: &F = &*(f as *const F);
    ...
    fn connect_decide_policy<F: Fn(&Self, &PolicyDecision, PolicyDecisionType) -> bool + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn decide_policy_trampoline<P, F: Fn(&P, &PolicyDecision, PolicyDecisionType) -> bool + 'static>(this: *mut ffi::WebKitWebView, decision: *mut ffi::WebKitPolicyDecision, decision_type: ffi::WebKitPolicyDecisionType, f: glib::ffi::gpointer) -> glib::ffi::gboolean
            where P: IsA<WebView>
        {
            let f: &F = &*(f as *const F);
    ...
    fn connect_enter_fullscreen<F: Fn(&Self) -> bool + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn enter_fullscreen_trampoline<P, F: Fn(&P) -> bool + 'static>(this: *mut ffi::WebKitWebView, f: glib::ffi::gpointer) -> glib::ffi::gboolean
            where P: IsA<WebView>
        {
            let f: &F = &*(f as *const F);
    ...
    fn connect_insecure_content_detected<F: Fn(&Self, InsecureContentEvent) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn insecure_content_detected_trampoline<P, F: Fn(&P, InsecureContentEvent) + 'static>(this: *mut ffi::WebKitWebView, event: ffi::WebKitInsecureContentEvent, f: glib::ffi::gpointer)
            where P: IsA<WebView>
        {
            let f: &F = &*(f as *const F);
    ...
    fn connect_leave_fullscreen<F: Fn(&Self) -> bool + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn leave_fullscreen_trampoline<P, F: Fn(&P) -> bool + 'static>(this: *mut ffi::WebKitWebView, f: glib::ffi::gpointer) -> glib::ffi::gboolean
            where P: IsA<WebView>
        {
            let f: &F = &*(f as *const F);
            f(&WebView::from_glib_borrow(this).unsafe_cast_ref()).to_glib()
    ...
    fn connect_load_changed<F: Fn(&Self, LoadEvent) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn load_changed_trampoline<P, F: Fn(&P, LoadEvent) + 'static>(this: *mut ffi::WebKitWebView, load_event: ffi::WebKitLoadEvent, f: glib::ffi::gpointer)
            where P: IsA<WebView>
        {
            let f: &F = &*(f as *const F);
    ...
    fn connect_load_failed<F: Fn(&Self, LoadEvent, &str, &glib::Error) -> bool + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn load_failed_trampoline<P, F: Fn(&P, LoadEvent, &str, &glib::Error) -> bool + 'static>(this: *mut ffi::WebKitWebView, load_event: ffi::WebKitLoadEvent, failing_uri: *mut libc::c_char, error: *mut glib::ffi::GError, f: glib::ffi::gpointer) -> glib::ffi::gboolean
            where P: IsA<WebView>
        {
            let f: &F = &*(f as *const F);
            f(&WebView::from_glib_borrow(this).unsafe_cast_ref(), from_glib(load_event), &glib::GString::from_glib_borrow(failing_uri), &from_glib_borrow(error)).to_glib()
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_6")))]
    fn connect_load_failed_with_tls_errors<F: Fn(&Self, &str, &gio::TlsCertificate, gio::TlsCertificateFlags) -> bool + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn load_failed_with_tls_errors_trampoline<P, F: Fn(&P, &str, &gio::TlsCertificate, gio::TlsCertificateFlags) -> bool + 'static>(this: *mut ffi::WebKitWebView, failing_uri: *mut libc::c_char, certificate: *mut gio::ffi::GTlsCertificate, errors: gio::ffi::GTlsCertificateFlags, f: glib::ffi::gpointer) -> glib::ffi::gboolean
            where P: IsA<WebView>
        {
            let f: &F = &*(f as *const F);
            f(&WebView::from_glib_borrow(this).unsafe_cast_ref(), &glib::GString::from_glib_borrow(failing_uri), &from_glib_borrow(certificate), from_glib(errors)).to_glib()
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
    ...
    fn connect_mouse_target_changed<F: Fn(&Self, &HitTestResult, u32) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn mouse_target_changed_trampoline<P, F: Fn(&P, &HitTestResult, u32) + 'static>(this: *mut ffi::WebKitWebView, hit_test_result: *mut ffi::WebKitHitTestResult, modifiers: libc::c_uint, f: glib::ffi::gpointer)
            where P: IsA<WebView>
        {
            let f: &F = &*(f as *const F);
    ...
    fn connect_permission_request<F: Fn(&Self, &PermissionRequest) -> bool + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn permission_request_trampoline<P, F: Fn(&P, &PermissionRequest) -> bool + 'static>(this: *mut ffi::WebKitWebView, request: *mut ffi::WebKitPermissionRequest, f: glib::ffi::gpointer) -> glib::ffi::gboolean
            where P: IsA<WebView>
        {
            let f: &F = &*(f as *const F);
            f(&WebView::from_glib_borrow(this).unsafe_cast_ref(), &from_glib_borrow(request)).to_glib()
    ...
    fn connect_print<F: Fn(&Self, &PrintOperation) -> bool + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn print_trampoline<P, F: Fn(&P, &PrintOperation) -> bool + 'static>(this: *mut ffi::WebKitWebView, print_operation: *mut ffi::WebKitPrintOperation, f: glib::ffi::gpointer) -> glib::ffi::gboolean
            where P: IsA<WebView>
        {
            let f: &F = &*(f as *const F);
    ...
    fn connect_ready_to_show<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn ready_to_show_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitWebView, f: glib::ffi::gpointer)
            where P: IsA<WebView>
        {
            let f: &F = &*(f as *const F);
            f(&WebView::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_resource_load_started<F: Fn(&Self, &WebResource, &URIRequest) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn resource_load_started_trampoline<P, F: Fn(&P, &WebResource, &URIRequest) + 'static>(this: *mut ffi::WebKitWebView, resource: *mut ffi::WebKitWebResource, request: *mut ffi::WebKitURIRequest, f: glib::ffi::gpointer)
            where P: IsA<WebView>
        {
            let f: &F = &*(f as *const F);
    ...
    fn connect_run_as_modal<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn run_as_modal_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitWebView, f: glib::ffi::gpointer)
            where P: IsA<WebView>
        {
            let f: &F = &*(f as *const F);
            f(&WebView::from_glib_borrow(this).unsafe_cast_ref())
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_8")))]
    fn connect_run_color_chooser<F: Fn(&Self, &ColorChooserRequest) -> bool + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn run_color_chooser_trampoline<P, F: Fn(&P, &ColorChooserRequest) -> bool + 'static>(this: *mut ffi::WebKitWebView, request: *mut ffi::WebKitColorChooserRequest, f: glib::ffi::gpointer) -> glib::ffi::gboolean
            where P: IsA<WebView>
        {
            let f: &F = &*(f as *const F);
            f(&WebView::from_glib_borrow(this).unsafe_cast_ref(), &from_glib_borrow(request)).to_glib()
    ...
    fn connect_run_file_chooser<F: Fn(&Self, &FileChooserRequest) -> bool + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn run_file_chooser_trampoline<P, F: Fn(&P, &FileChooserRequest) -> bool + 'static>(this: *mut ffi::WebKitWebView, request: *mut ffi::WebKitFileChooserRequest, f: glib::ffi::gpointer) -> glib::ffi::gboolean
            where P: IsA<WebView>
        {
            let f: &F = &*(f as *const F);
            f(&WebView::from_glib_borrow(this).unsafe_cast_ref(), &from_glib_borrow(request)).to_glib()
    ...
    fn connect_script_dialog<F: Fn(&Self, &ScriptDialog) -> bool + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn script_dialog_trampoline<P, F: Fn(&P, &ScriptDialog) -> bool + 'static>(this: *mut ffi::WebKitWebView, dialog: *mut ffi::WebKitScriptDialog, f: glib::ffi::gpointer) -> glib::ffi::gboolean
            where P: IsA<WebView>
        {
            let f: &F = &*(f as *const F);
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_8")))]
    fn connect_show_notification<F: Fn(&Self, &Notification) -> bool + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn show_notification_trampoline<P, F: Fn(&P, &Notification) -> bool + 'static>(this: *mut ffi::WebKitWebView, notification: *mut ffi::WebKitNotification, f: glib::ffi::gpointer) -> glib::ffi::gboolean
            where P: IsA<WebView>
        {
            let f: &F = &*(f as *const F);
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_28")))]
    fn connect_show_option_menu<F: Fn(&Self, &OptionMenu, &gdk::Event, &gdk::Rectangle) -> bool + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn show_option_menu_trampoline<P, F: Fn(&P, &OptionMenu, &gdk::Event, &gdk::Rectangle) -> bool + 'static>(this: *mut ffi::WebKitWebView, object: *mut ffi::WebKitOptionMenu, p0: *mut gdk::ffi::GdkEvent, p1: *mut gdk::ffi::GdkRectangle, f: glib::ffi::gpointer) -> glib::ffi::gboolean
            where P: IsA<WebView>
        {
            let f: &F = &*(f as *const F);
    ...
    fn connect_submit_form<F: Fn(&Self, &FormSubmissionRequest) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn submit_form_trampoline<P, F: Fn(&P, &FormSubmissionRequest) + 'static>(this: *mut ffi::WebKitWebView, request: *mut ffi::WebKitFormSubmissionRequest, f: glib::ffi::gpointer)
            where P: IsA<WebView>
        {
            let f: &F = &*(f as *const F);
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_28")))]
    fn connect_user_message_received<F: Fn(&Self, &UserMessage) -> bool + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn user_message_received_trampoline<P, F: Fn(&P, &UserMessage) -> bool + 'static>(this: *mut ffi::WebKitWebView, message: *mut ffi::WebKitUserMessage, f: glib::ffi::gpointer) -> glib::ffi::gboolean
            where P: IsA<WebView>
        {
            let f: &F = &*(f as *const F);
    ...
    fn connect_web_process_crashed<F: Fn(&Self) -> bool + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn web_process_crashed_trampoline<P, F: Fn(&P) -> bool + 'static>(this: *mut ffi::WebKitWebView, f: glib::ffi::gpointer) -> glib::ffi::gboolean
            where P: IsA<WebView>
        {
            let f: &F = &*(f as *const F);
            f(&WebView::from_glib_borrow(this).unsafe_cast_ref()).to_glib()
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_20")))]
    fn connect_web_process_terminated<F: Fn(&Self, WebProcessTerminationReason) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn web_process_terminated_trampoline<P, F: Fn(&P, WebProcessTerminationReason) + 'static>(this: *mut ffi::WebKitWebView, reason: ffi::WebKitWebProcessTerminationReason, f: glib::ffi::gpointer)
            where P: IsA<WebView>
        {
            let f: &F = &*(f as *const F);
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_8")))]
    fn connect_property_editable_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_editable_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitWebView, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<WebView>
        {
            let f: &F = &*(f as *const F);
            f(&WebView::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_estimated_load_progress_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_estimated_load_progress_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitWebView, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<WebView>
        {
            let f: &F = &*(f as *const F);
            f(&WebView::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_favicon_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_favicon_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitWebView, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<WebView>
        {
            let f: &F = &*(f as *const F);
            f(&WebView::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_is_loading_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_is_loading_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitWebView, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<WebView>
        {
            let f: &F = &*(f as *const F);
            f(&WebView::from_glib_borrow(this).unsafe_cast_ref())
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_30")))]
    fn connect_property_is_muted_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_is_muted_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitWebView, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<WebView>
        {
            let f: &F = &*(f as *const F);
            f(&WebView::from_glib_borrow(this).unsafe_cast_ref())
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_8")))]
    fn connect_property_is_playing_audio_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_is_playing_audio_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitWebView, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<WebView>
        {
            let f: &F = &*(f as *const F);
            f(&WebView::from_glib_borrow(this).unsafe_cast_ref())
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_28")))]
    fn connect_property_page_id_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_page_id_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitWebView, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<WebView>
        {
            let f: &F = &*(f as *const F);
            f(&WebView::from_glib_borrow(this).unsafe_cast_ref())
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_6")))]
    fn connect_property_settings_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_settings_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitWebView, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<WebView>
        {
            let f: &F = &*(f as *const F);
            f(&WebView::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_title_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_title_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitWebView, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<WebView>
        {
            let f: &F = &*(f as *const F);
            f(&WebView::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_uri_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_uri_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitWebView, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<WebView>
        {
            let f: &F = &*(f as *const F);
            f(&WebView::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_zoom_level_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_zoom_level_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitWebView, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<WebView>
        {
            let f: &F = &*(f as *const F);
            f(&WebView::from_glib_borrow(this).unsafe_cast_ref())
