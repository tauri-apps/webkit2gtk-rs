...
pub trait WebViewExt {
    //fn can_execute_editing_command<'a, 'b, P: Into<Option<&'a /*Ignored*/gio::Cancellable>>, Q: Into<Option<&'b /*Ignored*/gio::AsyncReadyCallback>>, R: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(&self, command: &str, cancellable: P, callback: Q, user_data: R);

    //fn can_execute_editing_command_finish<P: IsA</*Ignored*/gio::AsyncResult>>(&self, result: &P) -> Result<(), Error>;
    ...
    //#[cfg(feature = "v2_8")]
    //fn get_background_color(&self, rgba: /*Ignored*/gdk::RGBA);
    ...
    //fn get_favicon(&self) -> /*Ignored*/Option<cairo::Surface>;
    ...
    //#[cfg(feature = "v2_12")]
    //fn get_session_state(&self) -> /*Ignored*/Option<WebViewSessionState>;

    fn get_settings(&self) -> Option<Settings>;

    //fn get_snapshot<'a, 'b, P: Into<Option<&'a /*Ignored*/gio::Cancellable>>, Q: Into<Option<&'b /*Ignored*/gio::AsyncReadyCallback>>, R: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(&self, region: SnapshotRegion, options: SnapshotOptions, cancellable: P, callback: Q, user_data: R);

    //fn get_snapshot_finish<P: IsA</*Ignored*/gio::AsyncResult>>(&self, result: &P) -> Result</*Ignored*/cairo::Surface, Error>;

    fn get_title(&self) -> Option<String>;

    //fn get_tls_info(&self, certificate: /*Ignored*/gio::TlsCertificate) -> Option</*Ignored*/gio::TlsCertificateFlags>;
    ...
    //#[cfg(feature = "v2_6")]
    //fn load_bytes<'a, 'b, 'c, P: Into<Option<&'a str>>, Q: Into<Option<&'b str>>, R: Into<Option<&'c str>>>(&self, bytes: /*Ignored*/&glib::Bytes, mime_type: P, encoding: Q, base_uri: R);
    ...
    #[cfg(feature = "v2_4")]
    fn new_with_related_view(&self) -> Option<gtk::Widget>;
    ...
    //#[cfg(feature = "v2_12")]
    //fn restore_session_state(&self, state: /*Ignored*/&WebViewSessionState);

    //fn run_javascript<'a, 'b, P: Into<Option<&'a /*Ignored*/gio::Cancellable>>, Q: Into<Option<&'b /*Ignored*/gio::AsyncReadyCallback>>, R: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(&self, script: &str, cancellable: P, callback: Q, user_data: R);

    //fn run_javascript_finish<P: IsA</*Ignored*/gio::AsyncResult>>(&self, result: &P) -> Result<JavascriptResult, Error>;

    //fn run_javascript_from_gresource<'a, 'b, P: Into<Option<&'a /*Ignored*/gio::Cancellable>>, Q: Into<Option<&'b /*Ignored*/gio::AsyncReadyCallback>>, R: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(&self, resource: &str, cancellable: P, callback: Q, user_data: R);

    //fn run_javascript_from_gresource_finish<P: IsA</*Ignored*/gio::AsyncResult>>(&self, result: &P) -> Result<JavascriptResult, Error>;

    //fn save<'a, 'b, P: Into<Option<&'a /*Ignored*/gio::Cancellable>>, Q: Into<Option<&'b /*Ignored*/gio::AsyncReadyCallback>>, R: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(&self, save_mode: SaveMode, cancellable: P, callback: Q, user_data: R);

    //fn save_finish<P: IsA</*Ignored*/gio::AsyncResult>>(&self, result: &P) -> Result</*Ignored*/gio::InputStream, Error>;

    //fn save_to_file<'a, 'b, P: IsA</*Ignored*/gio::File>, Q: Into<Option<&'a /*Ignored*/gio::Cancellable>>, R: Into<Option<&'b /*Ignored*/gio::AsyncReadyCallback>>, S: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(&self, file: &P, save_mode: SaveMode, cancellable: Q, callback: R, user_data: S);

    //fn save_to_file_finish<P: IsA</*Ignored*/gio::AsyncResult>>(&self, result: &P) -> Result<(), Error>;

    //#[cfg(feature = "v2_8")]
    //fn set_background_color(&self, rgba: /*Ignored*/&gdk::RGBA);
    ...
    #[cfg(feature = "v2_2")]
    fn connect_authenticate<F: Fn(&Self, &AuthenticationRequest) -> bool + 'static>(&self, f: F) -> u64;

    fn connect_close<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    //fn connect_context_menu<Unsupported or ignored types>(&self, f: F) -> u64;

    fn connect_context_menu_dismissed<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v2_6")]
    fn connect_create<F: Fn(&Self, &NavigationAction) -> Option<gtk::Widget> + 'static>(&self, f: F) -> u64;

    fn connect_decide_policy<F: Fn(&Self, &PolicyDecision, PolicyDecisionType) -> bool + 'static>(&self, f: F) -> u64;

    fn connect_enter_fullscreen<F: Fn(&Self) -> bool + 'static>(&self, f: F) -> u64;

    fn connect_insecure_content_detected<F: Fn(&Self, InsecureContentEvent) + 'static>(&self, f: F) -> u64;

    fn connect_leave_fullscreen<F: Fn(&Self) -> bool + 'static>(&self, f: F) -> u64;

    fn connect_load_changed<F: Fn(&Self, LoadEvent) + 'static>(&self, f: F) -> u64;

    fn connect_load_failed<F: Fn(&Self, LoadEvent, &str, &Error) -> bool + 'static>(&self, f: F) -> u64;

    //#[cfg(feature = "v2_6")]
    //fn connect_load_failed_with_tls_errors<Unsupported or ignored types>(&self, f: F) -> u64;

    fn connect_mouse_target_changed<F: Fn(&Self, &HitTestResult, u32) + 'static>(&self, f: F) -> u64;

    fn connect_permission_request<F: Fn(&Self, &PermissionRequest) -> bool + 'static>(&self, f: F) -> u64;

    fn connect_print<F: Fn(&Self, &PrintOperation) -> bool + 'static>(&self, f: F) -> u64;

    fn connect_ready_to_show<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_resource_load_started<F: Fn(&Self, &WebResource, &URIRequest) + 'static>(&self, f: F) -> u64;

    fn connect_run_as_modal<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v2_8")]
    fn connect_run_color_chooser<F: Fn(&Self, &ColorChooserRequest) -> bool + 'static>(&self, f: F) -> u64;

    fn connect_run_file_chooser<F: Fn(&Self, &FileChooserRequest) -> bool + 'static>(&self, f: F) -> u64;

    fn connect_script_dialog<F: Fn(&Self, &ScriptDialog) -> bool + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v2_8")]
    fn connect_show_notification<F: Fn(&Self, &Notification) -> bool + 'static>(&self, f: F) -> u64;

    fn connect_submit_form<F: Fn(&Self, &FormSubmissionRequest) + 'static>(&self, f: F) -> u64;

    fn connect_web_process_crashed<F: Fn(&Self) -> bool + 'static>(&self, f: F) -> u64;
}
...
where P: IsA<WebView> {
    callback_guard!();
    let f: &Box_<Fn(&P, &AuthenticationRequest) -> bool + 'static> = transmute(f);
    f(&WebView::from_glib_none(this).downcast_unchecked(), &from_glib_none(request)).to_glib()
}
...
where P: IsA<WebView> {
    ...
    f(&WebView::from_glib_none(this).downcast_unchecked())
}
...
where P: IsA<WebView> {
    callback_guard!();
    let f: &Box_<Fn(&P, &NavigationAction) -> Option<gtk::Widget> + 'static> = transmute(f);
    f(&WebView::from_glib_none(this).downcast_unchecked(), &from_glib_none(navigation_action)).to_glib_full()
}
...
where P: IsA<WebView> {
    callback_guard!();
    let f: &Box_<Fn(&P, &PolicyDecision, PolicyDecisionType) -> bool + 'static> = transmute(f);
    f(&WebView::from_glib_none(this).downcast_unchecked(), &from_glib_none(decision), from_glib(decision_type)).to_glib()
}
...
where P: IsA<WebView> {
    ...
    f(&WebView::from_glib_none(this).downcast_unchecked()).to_glib()
}
...
where P: IsA<WebView> {
    callback_guard!();
    let f: &Box_<Fn(&P, InsecureContentEvent) + 'static> = transmute(f);
    f(&WebView::from_glib_none(this).downcast_unchecked(), from_glib(event))
}
...
where P: IsA<WebView> {
    callback_guard!();
    let f: &Box_<Fn(&P, LoadEvent) + 'static> = transmute(f);
    f(&WebView::from_glib_none(this).downcast_unchecked(), from_glib(load_event))
}
...
where P: IsA<WebView> {
    callback_guard!();
    let f: &Box_<Fn(&P, LoadEvent, &str, &Error) -> bool + 'static> = transmute(f);
    f(&WebView::from_glib_none(this).downcast_unchecked(), from_glib(load_event), &String::from_glib_none(failing_uri), &from_glib_none(error)).to_glib()
}
...
where P: IsA<WebView> {
    callback_guard!();
    let f: &Box_<Fn(&P, &HitTestResult, u32) + 'static> = transmute(f);
    f(&WebView::from_glib_none(this).downcast_unchecked(), &from_glib_none(hit_test_result), modifiers)
}
...
where P: IsA<WebView> {
    callback_guard!();
    let f: &Box_<Fn(&P, &PermissionRequest) -> bool + 'static> = transmute(f);
    f(&WebView::from_glib_none(this).downcast_unchecked(), &from_glib_none(request)).to_glib()
}
...
where P: IsA<WebView> {
    callback_guard!();
    let f: &Box_<Fn(&P, &PrintOperation) -> bool + 'static> = transmute(f);
    f(&WebView::from_glib_none(this).downcast_unchecked(), &from_glib_none(print_operation)).to_glib()
}
...
where P: IsA<WebView> {
    callback_guard!();
    let f: &Box_<Fn(&P, &WebResource, &URIRequest) + 'static> = transmute(f);
    f(&WebView::from_glib_none(this).downcast_unchecked(), &from_glib_none(resource), &from_glib_none(request))
}
...
where P: IsA<WebView> {
    callback_guard!();
    let f: &Box_<Fn(&P, &ColorChooserRequest) -> bool + 'static> = transmute(f);
    f(&WebView::from_glib_none(this).downcast_unchecked(), &from_glib_none(request)).to_glib()
}
...
where P: IsA<WebView> {
    callback_guard!();
    let f: &Box_<Fn(&P, &FileChooserRequest) -> bool + 'static> = transmute(f);
    f(&WebView::from_glib_none(this).downcast_unchecked(), &from_glib_none(request)).to_glib()
}
...
where P: IsA<WebView> {
    callback_guard!();
    let f: &Box_<Fn(&P, &ScriptDialog) -> bool + 'static> = transmute(f);
    f(&WebView::from_glib_none(this).downcast_unchecked(), &from_glib_none(dialog)).to_glib()
}
...
where P: IsA<WebView> {
    callback_guard!();
    let f: &Box_<Fn(&P, &Notification) -> bool + 'static> = transmute(f);
    f(&WebView::from_glib_none(this).downcast_unchecked(), &from_glib_none(notification)).to_glib()
}
...
where P: IsA<WebView> {
    callback_guard!();
    let f: &Box_<Fn(&P, &FormSubmissionRequest) + 'static> = transmute(f);
    f(&WebView::from_glib_none(this).downcast_unchecked(), &from_glib_none(request))
}
