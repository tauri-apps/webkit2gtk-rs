...
use crate::{
  ...
  PermissionRequest, PolicyDecision, PolicyDecisionType, PrintOperation, SaveMode, ScriptDialog,
...
pub trait WebViewExt: 'static {
  ...
  #[doc(alias = "print")]
  fn connect_print<F: Fn(&Self, &PrintOperation) -> bool + 'static>(&self, f: F)
    -> SignalHandlerId;
  ...
  fn connect_estimated_load_progress_notify<F: Fn(&Self) + 'static>(&self, f: F)
    -> SignalHandlerId;
