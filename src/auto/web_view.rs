...
impl WebView {
    ...
    //pub fn can_execute_editing_command_finish<T: IsA</*Ignored*/gio::AsyncResult>>(&self, result: &T) -> Result<(), Error> {
    ...
    //pub fn get_snapshot_finish<T: IsA</*Ignored*/gio::AsyncResult>>(&self, result: &T) -> Result</*Ignored*/cairo::Surface, Error> {
    ...
    //pub fn run_javascript_finish<T: IsA</*Ignored*/gio::AsyncResult>>(&self, result: &T) -> Result<JavascriptResult, Error> {
    ...
    //pub fn run_javascript_from_gresource_finish<T: IsA</*Ignored*/gio::AsyncResult>>(&self, result: &T) -> Result<JavascriptResult, Error> {
    ...
    //pub fn save_finish<T: IsA</*Ignored*/gio::AsyncResult>>(&self, result: &T) -> Result</*Ignored*/gio::InputStream, Error> {
    ...
    //pub fn save_to_file_finish<T: IsA</*Ignored*/gio::AsyncResult>>(&self, result: &T) -> Result<(), Error> {
