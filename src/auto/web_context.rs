...
if let Some(ref website_data_manager) = self.website_data_manager {
    ...
    #[cfg(any(feature = "v2_10", feature = "dox"))]
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_10")))]
    pub fn website_data_manager(mut self, website_data_manager: &impl IsA<WebsiteDataManager>) -> Self {
...
pub trait WebContextExt: 'static {
    ...
    fn plugins<P: FnOnce(Result<Vec<Plugin>, glib::Error>) + Send + 'static>(&self, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P);
...
impl<O: IsA<WebContext>> WebContextExt for O {
    ...
    fn plugins<P: FnOnce(Result<Vec<Plugin>, glib::Error>) + Send + 'static>(&self, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P) {
        ...
        unsafe extern "C" fn plugins_trampoline<P: FnOnce(Result<Vec<Plugin>, glib::Error>) + Send + 'static>(_source_object: *mut glib::gobject_ffi::GObject, res: *mut gio::ffi::GAsyncResult, user_data: glib::ffi::gpointer) {
