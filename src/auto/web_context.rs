...
if let Some(ref website_data_manager) = self.website_data_manager {
        ...
        let ret = glib::Object::new::<WebContext>(&properties)
            .expect("object new");
    ret
    }
...
pub trait WebContextExt: 'static {
    ...
    #[cfg(any(feature = "v2_8", feature = "dox"))]
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_8")))]
    #[doc(alias = "get_property_local_storage_directory")]
    fn local_storage_directory(&self) -> Option<glib::GString>;

    #[cfg(any(feature = "v2_28", feature = "dox"))]
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_28")))]
    #[doc(alias = "get_property_process_swap_on_cross_site_navigation_enabled")]
    ...
    #[cfg(any(feature = "v2_30", feature = "dox"))]
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_30")))]
    fn connect_property_use_system_appearance_for_scrollbars_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId;
}
...
impl<O: IsA<WebContext>> WebContextExt for O {
    ...
    fn add_path_to_sandbox<P: AsRef<std::path::Path>>(&self, path: P, read_only: bool) {
        unsafe {
            ffi::webkit_web_context_add_path_to_sandbox(self.as_ref().to_glib_none().0, path.as_ref().to_glib_none().0, read_only.to_glib());
        }
    }
    ...
    fn get_plugins<P: IsA<gio::Cancellable>, Q: FnOnce(Result<Vec<Plugin>, glib::Error>) + Send + 'static>(&self, cancellable: Option<&P>, callback: Q) {
        ...
        unsafe extern "C" fn get_plugins_trampoline<Q: FnOnce(Result<Vec<Plugin>, glib::Error>) + Send + 'static>(_source_object: *mut glib::gobject_ffi::GObject, res: *mut gio::ffi::GAsyncResult, user_data: glib::ffi::gpointer) {
    ...
    fn set_sandbox_enabled(&self, enabled: bool) {
        unsafe {
            ffi::webkit_web_context_set_sandbox_enabled(self.as_ref().to_glib_none().0, enabled.to_glib());
        }
    }
    ...
    fn set_use_system_appearance_for_scrollbars(&self, enabled: bool) {
        unsafe {
            ffi::webkit_web_context_set_use_system_appearance_for_scrollbars(self.as_ref().to_glib_none().0, enabled.to_glib());
        }
    }
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_18")))]
    fn connect_automation_started<F: Fn(&Self, &AutomationSession) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn automation_started_trampoline<P, F: Fn(&P, &AutomationSession) + 'static>(this: *mut ffi::WebKitWebContext, session: *mut ffi::WebKitAutomationSession, f: glib::ffi::gpointer)
    ...
    fn connect_download_started<F: Fn(&Self, &Download) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn download_started_trampoline<P, F: Fn(&P, &Download) + 'static>(this: *mut ffi::WebKitWebContext, download: *mut ffi::WebKitDownload, f: glib::ffi::gpointer)
            where P: IsA<WebContext>
        {
            let f: &F = &*(f as *const F);
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_16")))]
    fn connect_initialize_notification_permissions<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn initialize_notification_permissions_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitWebContext, f: glib::ffi::gpointer)
            where P: IsA<WebContext>
        {
            let f: &F = &*(f as *const F);
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_4")))]
    fn connect_initialize_web_extensions<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn initialize_web_extensions_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitWebContext, f: glib::ffi::gpointer)
            where P: IsA<WebContext>
        {
            let f: &F = &*(f as *const F);
            f(&WebContext::from_glib_borrow(this).unsafe_cast_ref())
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_28")))]
    fn connect_user_message_received<F: Fn(&Self, &UserMessage) -> bool + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn user_message_received_trampoline<P, F: Fn(&P, &UserMessage) -> bool + 'static>(this: *mut ffi::WebKitWebContext, message: *mut ffi::WebKitUserMessage, f: glib::ffi::gpointer) -> glib::ffi::gboolean
            where P: IsA<WebContext>
        {
            let f: &F = &*(f as *const F);
            f(&WebContext::from_glib_borrow(this).unsafe_cast_ref(), &from_glib_borrow(message)).to_glib()
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_30")))]
    fn connect_property_use_system_appearance_for_scrollbars_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_use_system_appearance_for_scrollbars_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitWebContext, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<WebContext>
        {
            let f: &F = &*(f as *const F);
            f(&WebContext::from_glib_borrow(this).unsafe_cast_ref())
