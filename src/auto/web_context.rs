...
if let Some(ref website_data_manager) = self.website_data_manager {
    ...
    #[cfg(any(feature = "v2_34", feature = "dox"))]
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_34")))]
    pub fn memory_pressure_settings(mut self, memory_pressure_settings: &MemoryPressureSettings) -> Self {
...
impl<O: IsA<WebContext>> WebContextExt for O {
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_28")))]
    fn is_process_swap_on_cross_site_navigation_enabled(&self) -> bool {
        glib::ObjectExt::property(self.as_ref(), "process-swap-on-cross-site-navigation-enabled")
    }
