...
impl<O: IsA<InputMethodContext>> InputMethodContextExt for O {
    ...
    fn set_enable_preedit(&self, enabled: bool) {
        unsafe {
            ffi::webkit_input_method_context_set_enable_preedit(self.as_ref().to_glib_none().0, enabled.to_glib());
        }
    }

    fn set_input_hints(&self, hints: InputHints) {
        unsafe {
            ffi::webkit_input_method_context_set_input_hints(self.as_ref().to_glib_none().0, hints.to_glib());
        }
    }

    fn set_input_purpose(&self, purpose: InputPurpose) {
        unsafe {
            ffi::webkit_input_method_context_set_input_purpose(self.as_ref().to_glib_none().0, purpose.to_glib());
        }
    }
    ...
    fn set_property_input_hints(&self, input_hints: InputHints) {
        unsafe {
            glib::gobject_ffi::g_object_set_property(self.to_glib_none().0 as *mut glib::gobject_ffi::GObject, b"input-hints\0".as_ptr() as *const _, glib::Value::from(&input_hints).to_glib_none().0);
        }
    }
    ...
    fn set_property_input_purpose(&self, input_purpose: InputPurpose) {
        unsafe {
            glib::gobject_ffi::g_object_set_property(self.to_glib_none().0 as *mut glib::gobject_ffi::GObject, b"input-purpose\0".as_ptr() as *const _, glib::Value::from(&input_purpose).to_glib_none().0);
        }
    }
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_28")))]
    fn connect_committed<F: Fn(&Self, &str) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn committed_trampoline<P, F: Fn(&P, &str) + 'static>(this: *mut ffi::WebKitInputMethodContext, text: *mut libc::c_char, f: glib::ffi::gpointer)
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_28")))]
    fn connect_delete_surrounding<F: Fn(&Self, i32, u32) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn delete_surrounding_trampoline<P, F: Fn(&P, i32, u32) + 'static>(this: *mut ffi::WebKitInputMethodContext, offset: libc::c_int, n_chars: libc::c_uint, f: glib::ffi::gpointer)
            where P: IsA<InputMethodContext>
        {
            let f: &F = &*(f as *const F);
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_28")))]
    fn connect_preedit_changed<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn preedit_changed_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitInputMethodContext, f: glib::ffi::gpointer)
            where P: IsA<InputMethodContext>
        {
            let f: &F = &*(f as *const F);
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_28")))]
    fn connect_preedit_finished<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn preedit_finished_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitInputMethodContext, f: glib::ffi::gpointer)
            where P: IsA<InputMethodContext>
        {
            let f: &F = &*(f as *const F);
            f(&InputMethodContext::from_glib_borrow(this).unsafe_cast_ref())
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_28")))]
    fn connect_preedit_started<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn preedit_started_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitInputMethodContext, f: glib::ffi::gpointer)
            where P: IsA<InputMethodContext>
        {
            let f: &F = &*(f as *const F);
            f(&InputMethodContext::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_input_hints_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_input_hints_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitInputMethodContext, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<InputMethodContext>
        {
            let f: &F = &*(f as *const F);
            f(&InputMethodContext::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_input_purpose_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_input_purpose_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitInputMethodContext, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<InputMethodContext>
        {
            let f: &F = &*(f as *const F);
            f(&InputMethodContext::from_glib_borrow(this).unsafe_cast_ref())
