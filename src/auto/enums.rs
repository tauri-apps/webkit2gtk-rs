...
impl ToGlib for AutomationBrowsingContextPresentation {
    ...
    fn to_glib(&self) -> ffi::WebKitAutomationBrowsingContextPresentation {
        match *self {
            AutomationBrowsingContextPresentation::Window => ffi::WEBKIT_AUTOMATION_BROWSING_CONTEXT_PRESENTATION_WINDOW,
            AutomationBrowsingContextPresentation::Tab => ffi::WEBKIT_AUTOMATION_BROWSING_CONTEXT_PRESENTATION_TAB,
...
impl ToGlib for ContextMenuAction {
    ...
    fn to_glib(&self) -> ffi::WebKitContextMenuAction {
        match *self {
            ...
            ContextMenuAction::PasteAsPlainText => ffi::WEBKIT_CONTEXT_MENU_ACTION_PASTE_AS_PLAIN_TEXT,
...
impl ToGlib for UserContentFilterError {
    ...
    fn to_glib(&self) -> ffi::WebKitUserContentFilterError {
        match *self {
            UserContentFilterError::InvalidSource => ffi::WEBKIT_USER_CONTENT_FILTER_ERROR_INVALID_SOURCE,
...
impl ToGlib for WebProcessTerminationReason {
    ...
    fn to_glib(&self) -> ffi::WebKitWebProcessTerminationReason {
        match *self {
            ...
            WebProcessTerminationReason::ExceededMemoryLimit => ffi::WEBKIT_WEB_PROCESS_EXCEEDED_MEMORY_LIMIT,
