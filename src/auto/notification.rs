...
impl<O: IsA<Notification>> NotificationExt for O {
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_12")))]
    fn connect_clicked<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn clicked_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitNotification, f: glib::ffi::gpointer)
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_8")))]
    fn connect_closed<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn closed_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitNotification, f: glib::ffi::gpointer)
            where P: IsA<Notification>
        {
            let f: &F = &*(f as *const F);
            f(&Notification::from_glib_borrow(this).unsafe_cast_ref())
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_8")))]
    fn connect_property_body_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_body_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitNotification, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<Notification>
        {
            let f: &F = &*(f as *const F);
            f(&Notification::from_glib_borrow(this).unsafe_cast_ref())
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_8")))]
    fn connect_property_id_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_id_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitNotification, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<Notification>
        {
            let f: &F = &*(f as *const F);
            f(&Notification::from_glib_borrow(this).unsafe_cast_ref())
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_16")))]
    fn connect_property_tag_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_tag_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitNotification, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<Notification>
        {
            let f: &F = &*(f as *const F);
            f(&Notification::from_glib_borrow(this).unsafe_cast_ref())
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_8")))]
    fn connect_property_title_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_title_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitNotification, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<Notification>
        {
            let f: &F = &*(f as *const F);
            f(&Notification::from_glib_borrow(this).unsafe_cast_ref())
