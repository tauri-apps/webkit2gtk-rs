...
if let Some(ref web_view) = self.web_view {
        ...
        let ret = glib::Object::new::<PrintOperation>(&properties)
            .expect("object new");
    ret
    }
...
pub trait PrintOperationExt: 'static {
    ...
    #[doc(alias = "get_property_web_view")]
...
impl<O: IsA<PrintOperation>> PrintOperationExt for O {
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_16")))]
    fn connect_create_custom_widget<F: Fn(&Self) -> PrintCustomWidget + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn create_custom_widget_trampoline<P, F: Fn(&P) -> PrintCustomWidget + 'static>(this: *mut ffi::WebKitPrintOperation, f: glib::ffi::gpointer) -> *mut ffi::WebKitPrintCustomWidget
    ...
    fn connect_failed<F: Fn(&Self, &glib::Error) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn failed_trampoline<P, F: Fn(&P, &glib::Error) + 'static>(this: *mut ffi::WebKitPrintOperation, error: *mut glib::ffi::GError, f: glib::ffi::gpointer)
            where P: IsA<PrintOperation>
        {
            let f: &F = &*(f as *const F);
    ...
    fn connect_finished<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn finished_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitPrintOperation, f: glib::ffi::gpointer)
            where P: IsA<PrintOperation>
        {
            let f: &F = &*(f as *const F);
    ...
    fn connect_property_page_setup_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_page_setup_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitPrintOperation, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<PrintOperation>
        {
            let f: &F = &*(f as *const F);
            f(&PrintOperation::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_print_settings_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_print_settings_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitPrintOperation, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<PrintOperation>
        {
            let f: &F = &*(f as *const F);
            f(&PrintOperation::from_glib_borrow(this).unsafe_cast_ref())
