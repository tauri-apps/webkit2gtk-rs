...
pub trait PrintOperationExt {
    ...
    #[cfg(feature = "v2_16")]
    fn connect_create_custom_widget<F: Fn(&Self) -> PrintCustomWidget + 'static>(&self, f: F) -> u64;

    fn connect_failed<F: Fn(&Self, &Error) + 'static>(&self, f: F) -> u64;

    fn connect_finished<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_page_setup_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_print_settings_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
