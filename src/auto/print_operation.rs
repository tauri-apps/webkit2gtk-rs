...
pub trait PrintOperationExt {
    ...
    //#[cfg(feature = "v2_16")]
    //fn connect_create_custom_widget<Unsupported or ignored types>(&self, f: F) -> u64;
...
where P: IsA<PrintOperation> {
    ...
    f(&PrintOperation::from_glib_none(this).downcast_unchecked(), &from_glib_none(error))
}
...
where P: IsA<PrintOperation> {
    ...
    f(&PrintOperation::from_glib_none(this).downcast_unchecked())
}
