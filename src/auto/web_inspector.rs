...
impl<O: IsA<WebInspector>> WebInspectorExt for O {
    ...
    fn connect_attach<F: Fn(&Self) -> bool + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn attach_trampoline<P, F: Fn(&P) -> bool + 'static>(this: *mut ffi::WebKitWebInspector, f: glib::ffi::gpointer) -> glib::ffi::gboolean
    ...
    fn connect_bring_to_front<F: Fn(&Self) -> bool + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn bring_to_front_trampoline<P, F: Fn(&P) -> bool + 'static>(this: *mut ffi::WebKitWebInspector, f: glib::ffi::gpointer) -> glib::ffi::gboolean
            where P: IsA<WebInspector>
        {
            let f: &F = &*(f as *const F);
            f(&WebInspector::from_glib_borrow(this).unsafe_cast_ref()).to_glib()
    ...
    fn connect_closed<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn closed_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitWebInspector, f: glib::ffi::gpointer)
            where P: IsA<WebInspector>
        {
            let f: &F = &*(f as *const F);
    ...
    fn connect_detach<F: Fn(&Self) -> bool + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn detach_trampoline<P, F: Fn(&P) -> bool + 'static>(this: *mut ffi::WebKitWebInspector, f: glib::ffi::gpointer) -> glib::ffi::gboolean
            where P: IsA<WebInspector>
        {
            let f: &F = &*(f as *const F);
            f(&WebInspector::from_glib_borrow(this).unsafe_cast_ref()).to_glib()
    ...
    fn connect_open_window<F: Fn(&Self) -> bool + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn open_window_trampoline<P, F: Fn(&P) -> bool + 'static>(this: *mut ffi::WebKitWebInspector, f: glib::ffi::gpointer) -> glib::ffi::gboolean
            where P: IsA<WebInspector>
        {
            let f: &F = &*(f as *const F);
            f(&WebInspector::from_glib_borrow(this).unsafe_cast_ref()).to_glib()
    ...
    fn connect_property_attached_height_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_attached_height_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitWebInspector, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<WebInspector>
        {
            let f: &F = &*(f as *const F);
            f(&WebInspector::from_glib_borrow(this).unsafe_cast_ref())
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_8")))]
    fn connect_property_can_attach_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_can_attach_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitWebInspector, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<WebInspector>
        {
            let f: &F = &*(f as *const F);
            f(&WebInspector::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_inspected_uri_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_inspected_uri_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitWebInspector, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<WebInspector>
        {
            let f: &F = &*(f as *const F);
            f(&WebInspector::from_glib_borrow(this).unsafe_cast_ref())
