...
pub trait WebInspectorExt {
    ...
    fn connect_property_attached_height_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v2_8")]
    fn connect_property_can_attach_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_inspected_uri_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}
