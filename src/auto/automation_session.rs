...
impl<O: IsA<AutomationSession>> AutomationSessionExt for O {
    ...
    fn get_application_info(&self) -> Option<ApplicationInfo> {
        unsafe {
            from_glib_none(webkit2_sys::webkit_automation_session_get_application_info(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn get_id(&self) -> Option<GString> {
        unsafe {
            from_glib_none(webkit2_sys::webkit_automation_session_get_id(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_application_info(&self, info: &ApplicationInfo) {
        unsafe {
            webkit2_sys::webkit_automation_session_set_application_info(self.as_ref().to_glib_none().0, info.to_glib_none().0);
        }
    }

    #[cfg(any(feature = "v2_18", feature = "dox"))]
    fn connect_create_web_view<F: Fn(&Self) -> WebView + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn create_web_view_trampoline<P, F: Fn(&P) -> WebView + 'static>(this: *mut webkit2_sys::WebKitAutomationSession, f: glib_sys::gpointer) -> *mut webkit2_sys::WebKitWebView
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"create-web-view\0".as_ptr() as *const _,
