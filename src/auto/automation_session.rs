...
impl AutomationSession {
    ...
    /// Creates a new builder-style object to construct a [`AutomationSession`].
    ///
    /// This method returns an instance of [`AutomationSessionBuilder`] which can be used to create a [`AutomationSession`].
...
// rustdoc-stripper-ignore-next
/// A builder for generating a [`AutomationSession`].
