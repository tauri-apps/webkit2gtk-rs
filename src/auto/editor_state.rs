...
impl<O: IsA<EditorState>> EditorStateExt for O {
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_10")))]
    fn connect_property_typing_attributes_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_typing_attributes_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitEditorState, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
