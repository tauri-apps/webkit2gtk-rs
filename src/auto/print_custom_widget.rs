...
impl PrintCustomWidget {
    ...
    /// Creates a new builder-style object to construct a [`PrintCustomWidget`].
    ///
    /// This method returns an instance of [`PrintCustomWidgetBuilder`] which can be used to create a [`PrintCustomWidget`].
...
// rustdoc-stripper-ignore-next
/// A builder for generating a [`PrintCustomWidget`].
