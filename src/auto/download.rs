...
if let Some(ref allow_overwrite) = self.allow_overwrite {
        ...
        let ret = glib::Object::new::<Download>(&properties)
            .expect("object new");
    ret
    }
...
impl<O: IsA<Download>> DownloadExt for O {
    ...
    fn connect_created_destination<F: Fn(&Self, &str) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn created_destination_trampoline<P, F: Fn(&P, &str) + 'static>(this: *mut ffi::WebKitDownload, destination: *mut libc::c_char, f: glib::ffi::gpointer)
    ...
    fn connect_decide_destination<F: Fn(&Self, &str) -> bool + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn decide_destination_trampoline<P, F: Fn(&P, &str) -> bool + 'static>(this: *mut ffi::WebKitDownload, suggested_filename: *mut libc::c_char, f: glib::ffi::gpointer) -> glib::ffi::gboolean
            where P: IsA<Download>
        {
            let f: &F = &*(f as *const F);
            f(&Download::from_glib_borrow(this).unsafe_cast_ref(), &glib::GString::from_glib_borrow(suggested_filename)).to_glib()
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
    ...
    fn connect_failed<F: Fn(&Self, &glib::Error) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn failed_trampoline<P, F: Fn(&P, &glib::Error) + 'static>(this: *mut ffi::WebKitDownload, error: *mut glib::ffi::GError, f: glib::ffi::gpointer)
            where P: IsA<Download>
        {
            let f: &F = &*(f as *const F);
    ...
    fn connect_finished<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn finished_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDownload, f: glib::ffi::gpointer)
            where P: IsA<Download>
        {
            let f: &F = &*(f as *const F);
    ...
    fn connect_received_data<F: Fn(&Self, u64) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn received_data_trampoline<P, F: Fn(&P, u64) + 'static>(this: *mut ffi::WebKitDownload, data_length: u64, f: glib::ffi::gpointer)
            where P: IsA<Download>
        {
            let f: &F = &*(f as *const F);
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_6")))]
    fn connect_property_allow_overwrite_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_allow_overwrite_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDownload, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<Download>
        {
            let f: &F = &*(f as *const F);
            f(&Download::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_destination_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_destination_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDownload, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<Download>
        {
            let f: &F = &*(f as *const F);
            f(&Download::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_estimated_progress_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_estimated_progress_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDownload, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<Download>
        {
            let f: &F = &*(f as *const F);
            f(&Download::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_response_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_response_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDownload, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<Download>
        {
            let f: &F = &*(f as *const F);
            f(&Download::from_glib_borrow(this).unsafe_cast_ref())
