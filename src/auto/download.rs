...
pub trait DownloadExt {
    ...
    #[cfg(feature = "v2_6")]
    fn connect_property_allow_overwrite_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_destination_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_estimated_progress_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
