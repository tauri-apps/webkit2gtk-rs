...
pub trait WebsiteDataManagerExt {
    ...
    #[cfg(feature = "v2_10")]
    fn connect_property_base_cache_directory_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v2_10")]
    fn connect_property_base_data_directory_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v2_10")]
    fn connect_property_disk_cache_directory_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v2_10")]
    fn connect_property_indexeddb_directory_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v2_16")]
    fn connect_property_is_ephemeral_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v2_10")]
    fn connect_property_local_storage_directory_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v2_10")]
    fn connect_property_offline_application_cache_directory_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v2_10")]
    fn connect_property_websql_directory_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}
