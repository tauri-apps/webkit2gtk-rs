...
pub trait WebsiteDataManagerExt: 'static {
    ...
    fn clear<P: FnOnce(Result<(), glib::Error>) + Send + 'static>(&self, types: WebsiteDataTypes, timespan: glib::TimeSpan, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P);
    ...
    fn fetch<P: FnOnce(Result<Vec<WebsiteData>, glib::Error>) + Send + 'static>(&self, types: WebsiteDataTypes, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P);
    ...
    fn itp_summary<P: FnOnce(Result<Vec<ITPThirdParty>, glib::Error>) + Send + 'static>(&self, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P);
...
impl<O: IsA<WebsiteDataManager>> WebsiteDataManagerExt for O {
    ...
    fn clear<P: FnOnce(Result<(), glib::Error>) + Send + 'static>(&self, types: WebsiteDataTypes, timespan: glib::TimeSpan, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P) {
        ...
        unsafe extern "C" fn clear_trampoline<P: FnOnce(Result<(), glib::Error>) + Send + 'static>(_source_object: *mut glib::gobject_ffi::GObject, res: *mut gio::ffi::GAsyncResult, user_data: glib::ffi::gpointer) {
    ...
    fn fetch<P: FnOnce(Result<Vec<WebsiteData>, glib::Error>) + Send + 'static>(&self, types: WebsiteDataTypes, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P) {
        let user_data: Box_<P> = Box_::new(callback);
        unsafe extern "C" fn fetch_trampoline<P: FnOnce(Result<Vec<WebsiteData>, glib::Error>) + Send + 'static>(_source_object: *mut glib::gobject_ffi::GObject, res: *mut gio::ffi::GAsyncResult, user_data: glib::ffi::gpointer) {
            let mut error = ptr::null_mut();
    ...
    fn itp_summary<P: FnOnce(Result<Vec<ITPThirdParty>, glib::Error>) + Send + 'static>(&self, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P) {
        let user_data: Box_<P> = Box_::new(callback);
        unsafe extern "C" fn itp_summary_trampoline<P: FnOnce(Result<Vec<ITPThirdParty>, glib::Error>) + Send + 'static>(_source_object: *mut glib::gobject_ffi::GObject, res: *mut gio::ffi::GAsyncResult, user_data: glib::ffi::gpointer) {
            let mut error = ptr::null_mut();
