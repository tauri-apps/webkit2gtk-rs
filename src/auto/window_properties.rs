...
pub trait WindowPropertiesExt {
    ...
    fn connect_property_fullscreen_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_geometry_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_locationbar_visible_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_menubar_visible_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_resizable_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_scrollbars_visible_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_statusbar_visible_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_toolbar_visible_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}
