...
impl<O: IsA<WebResource>> WebResourceExt for O {
    fn get_data<P: IsA<gio::Cancellable>, Q: FnOnce(Result<Vec<u8>, glib::Error>) + Send + 'static>(&self, cancellable: Option<&P>, callback: Q) {
        ...
        unsafe extern "C" fn get_data_trampoline<Q: FnOnce(Result<Vec<u8>, glib::Error>) + Send + 'static>(_source_object: *mut glib::gobject_ffi::GObject, res: *mut gio::ffi::GAsyncResult, user_data: glib::ffi::gpointer) {
    ...
    fn connect_failed<F: Fn(&Self, &glib::Error) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn failed_trampoline<P, F: Fn(&P, &glib::Error) + 'static>(this: *mut ffi::WebKitWebResource, error: *mut glib::ffi::GError, f: glib::ffi::gpointer)
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_8")))]
    fn connect_failed_with_tls_errors<F: Fn(&Self, &gio::TlsCertificate, gio::TlsCertificateFlags) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn failed_with_tls_errors_trampoline<P, F: Fn(&P, &gio::TlsCertificate, gio::TlsCertificateFlags) + 'static>(this: *mut ffi::WebKitWebResource, certificate: *mut gio::ffi::GTlsCertificate, errors: gio::ffi::GTlsCertificateFlags, f: glib::ffi::gpointer)
            where P: IsA<WebResource>
        {
            let f: &F = &*(f as *const F);
    ...
    fn connect_finished<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn finished_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitWebResource, f: glib::ffi::gpointer)
            where P: IsA<WebResource>
        {
            let f: &F = &*(f as *const F);
    ...
    fn connect_received_data<F: Fn(&Self, u64) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn received_data_trampoline<P, F: Fn(&P, u64) + 'static>(this: *mut ffi::WebKitWebResource, data_length: u64, f: glib::ffi::gpointer)
            where P: IsA<WebResource>
        {
            let f: &F = &*(f as *const F);
    ...
    fn connect_sent_request<F: Fn(&Self, &URIRequest, &URIResponse) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn sent_request_trampoline<P, F: Fn(&P, &URIRequest, &URIResponse) + 'static>(this: *mut ffi::WebKitWebResource, request: *mut ffi::WebKitURIRequest, redirected_response: *mut ffi::WebKitURIResponse, f: glib::ffi::gpointer)
            where P: IsA<WebResource>
        {
            let f: &F = &*(f as *const F);
    ...
    fn connect_property_response_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_response_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitWebResource, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<WebResource>
        {
            let f: &F = &*(f as *const F);
            f(&WebResource::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_uri_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_uri_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitWebResource, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<WebResource>
        {
            let f: &F = &*(f as *const F);
            f(&WebResource::from_glib_borrow(this).unsafe_cast_ref())
