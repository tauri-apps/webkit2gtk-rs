...
impl WebResource {
    ...
    //pub fn get_data_finish<T: IsA</*Ignored*/gio::AsyncResult>>(&self, result: &T) -> Result<(/*Unimplemented*/CArray TypeId { ns_id: 0, id: 3 }, /*Unimplemented*/Fundamental: Size), Error> {
