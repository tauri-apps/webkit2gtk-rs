...
impl WebsiteData {
    ...
    pub fn get_name(&self) -> Option<GString> {
        unsafe {
            from_glib_none(webkit2_sys::webkit_website_data_get_name(self.to_glib_none().0))
        }
    }
    ...
    pub fn get_size(&self, types: WebsiteDataTypes) -> u64 {
        unsafe {
            webkit2_sys::webkit_website_data_get_size(self.to_glib_none().0, types.to_glib())
        }
    }
    ...
    pub fn get_types(&self) -> WebsiteDataTypes {
        unsafe {
            from_glib(webkit2_sys::webkit_website_data_get_types(self.to_glib_none().0))
        }
    }
}
